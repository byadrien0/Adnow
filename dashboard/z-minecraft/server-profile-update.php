...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['serverId'], $_POST['serverName'], $_POST['serverCategory'], $_POST['serverWebsite'])) {
    ...
    $sql = "UPDATE servers_minecraft SET nom = ?, category = ?, website = ? WHERE id = ?";
    ...
    $stmt->bind_param("sssi", $serverName, $serverCategory, $serverWebsite, $serverId);
    ...
    if ($stmt->execute()) {
        ...
        header("Location: /dashboard/z-minecraft/server-profile.php?id=$serverId");
        exit();
    } else {
