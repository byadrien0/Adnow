                                    ...
                                    <div class="card position-relative">
                                        <div class="card-body text-center">
                                            <div class="position-relative">
                                                <?php
                                                $logoUrl = !empty($server['icon_url']) ? $server['icon_url'] : 'https://preview.redd.it/made-myself-a-custom-discord-icon-v0-t9j9padwfdqb1.png?width=640&crop=smart&auto=webp&s=c02aa2a3b65baf6d11aa659da583115ba6c8218f';
                                                ?>
                                                ...
                                                <p class="text-muted mb-1">Discord</p>
                                        ...
                                        <div class="card-footer text-end">
                                            <a class="btn btn-outline-primary"
                                                href="/dashboard/z-discord/server-profile.php?id=<?php echo htmlspecialchars($server['id']); ?>">
